package com.marcuschu.aicodegenerate.ai.model.core.streamHandler;
...
import com.marcuschu.aicodegenerate.ai.model.message.*;
    ...
    public Flux<String> handle(Flux<String> originFlux, ChatHistoryService chatHistoryService, long appId, User loginUser) {
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    chatHistoryService.saveMessage(appId, loginUser.getId(), aiResponse, ChatHistoryMessageTypeEnum.AI, null);
                    // 异步构造 Vue 项目
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.saveMessage(appId,  loginUser.getId(), errorMessage, ChatHistoryMessageTypeEnum.AI, null);
                });
    }
